...
pub struct UNet<B: Backend> {
    pub enc_conv0:  Conv2d<B>,
    pub enc_conv1:  Conv2d<B>,
    pub enc_conv2:  Conv2d<B>,
    pub enc_conv3:  Conv2d<B>,
    pub enc_conv4:  Conv2d<B>,
    pub enc_conv5a: Conv2d<B>,
    pub enc_conv5b: Conv2d<B>,
    pub dec_conv4a: Conv2d<B>,
    pub dec_conv4b: Conv2d<B>,
    pub dec_conv3a: Conv2d<B>,
    pub dec_conv3b: Conv2d<B>,
    pub dec_conv2a: Conv2d<B>,
    pub dec_conv2b: Conv2d<B>,
    pub dec_conv1a: Conv2d<B>,
    pub dec_conv1b: Conv2d<B>,
    pub dec_conv0:  Conv2d<B>,
    pub pool: MaxPool2d,
...
impl<B: Backend> UNet<B> {
    ...
    pub fn new(in_channels: usize, out_channels: usize, variant: Variant, device: &B::Device) -> Self {
