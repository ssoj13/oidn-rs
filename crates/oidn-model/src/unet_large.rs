...
use burn::{
    ...
    tensor::{Tensor, activation::relu, backend::Backend, module::interpolate, ops::{InterpolateMode, InterpolateOptions}},
};

fn conv3<B: Backend>(in_ch: usize, out_ch: usize, device: &B::Device) -> Conv2d<B> {
...
pub struct ChannelConfigLarge {
    pub ec1: usize, pub ec2: usize, pub ec3: usize, pub ec4: usize, pub ec5: usize,
    pub dc4: usize, pub dc3: usize, pub dc2: usize, pub dc1: usize,
}

impl ChannelConfigLarge {
    pub const BASE: Self = Self {
        ec1: 64, ec2: 96, ec3: 128, ec4: 192, ec5: 256,
        dc4: 192, dc3: 128, dc2: 96, dc1: 64,
    };

    pub const XL: Self = Self {
        ec1: 96, ec2: 128, ec3: 192, ec4: 256, ec5: 384,
        dc4: 256, dc3: 192, dc2: 128, dc1: 96,
    };
}

/// UNetLarge denoiser network.
#[derive(Module, Debug)]
pub struct UNetLarge<B: Backend> {
    pub enc_conv1a: Conv2d<B>, pub enc_conv1b: Conv2d<B>,
    pub enc_conv2a: Conv2d<B>, pub enc_conv2b: Conv2d<B>,
    pub enc_conv3a: Conv2d<B>, pub enc_conv3b: Conv2d<B>,
    pub enc_conv4a: Conv2d<B>, pub enc_conv4b: Conv2d<B>,
    pub enc_conv5a: Conv2d<B>, pub enc_conv5b: Conv2d<B>,
    pub dec_conv4a: Conv2d<B>, pub dec_conv4b: Conv2d<B>,
    pub dec_conv3a: Conv2d<B>, pub dec_conv3b: Conv2d<B>,
    pub dec_conv2a: Conv2d<B>, pub dec_conv2b: Conv2d<B>,
    pub dec_conv1a: Conv2d<B>, pub dec_conv1b: Conv2d<B>, pub dec_conv1c: Conv2d<B>,
    pub pool: MaxPool2d,
    pub in_channels: usize,
}

impl<B: Backend> UNetLarge<B> {
    pub fn new_with(in_channels: usize, out_channels: usize, c: ChannelConfigLarge, device: &B::Device) -> Self {
        let ic = in_channels;
        let oc = out_channels;
        Self {
    ...
    pub fn new_xl(in_channels: usize, out_channels: usize, device: &B::Device) -> Self {
